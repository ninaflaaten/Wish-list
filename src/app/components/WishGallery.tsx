...
export function WishGallery() {
  return (
    <>
      ...
      <WishItem
        title="Kérastase Genesis Duo Coffret"
      ...
      <WishItem
        title="Rema1000 / Coop / Tise / Zara gavekort"
      ...
      <WishItem
        ...
        link="https://www.google.com/search?q=ansiktsskrubb"
      />
